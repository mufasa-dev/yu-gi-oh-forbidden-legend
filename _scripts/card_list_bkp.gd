...
const card_list = {
  ...
  "00247": {
	"card_name": "Lyna the Light3D Charmer",
	"attribute": "light",
	"level": 3,
	"atk": 500,
	"def": 1500,
  ...
  "00392": {
	"card_name": "Soul of Purity and Light3D",
	"attribute": "light",
	"level": 6,
	"atk": 2000,
	"def": 1800,
  ...
  "00922": {
	"card_name": "Light3D and Darkness Dragon",
	"attribute": "light",
	"level": 8,
	"atk": 2800,
	"def": 2400,
